			...
			promise = new Promise(function(resolve, reject) {
				...
				var requests = _.map(requiredGames, function(game) {
					...
					.then(function(gameWithAchievements) {
						...
						{
							var storeGame = store.data[gameWithAchievements.appid];
							...
							{
								var lowest = _.min(storeGame.achievements, function(achievement) { return achievement.globalCompletionPercentage; });
